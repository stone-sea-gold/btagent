...
def save_holdings_endpoint(req: HoldingsSaveRequest):
...
def get_portfolio_status_endpoint(session_id: str):
...
@router.post("/rules")
def save_position_rules_endpoint(req: PositionRulesSaveRequest):
